...
$diamond = mysqli_query($conn, "SELECT * FROM pubg");
      ...
      <div class="buy">
            ...
            <div class="buy_content">
                  <form action="" method="post">
                        ...
                        <input type="text" class="userid" id="username_game" name="username_game"  placeholder="pubg" required>
