...
$topup = mysqli_query($conn, "SELECT * FROM pulsa");
...
<body class="pulsa">
  ...
  <!-- nav end -->
      ...
      <div class="buy">
            <div class="buy_title">
                  <a href="" class="nama">Pulsa Reguler</a>
            </div>
            <div class="buy_content">
                  <form action="" method="post">
                        <label for="userid" class="title-id">Masukkan Nomor HP:</label>
                        <input type="tel" class="userid" id="userid" name="userid" autofocus placeholder="972974186" required>
                        ...
                        <div class="beli">
                        <?php $x = 1; ?>
                        <?php while($beli = mysqli_fetch_assoc($topup)): ?>
